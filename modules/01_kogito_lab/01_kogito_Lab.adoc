...
. Check the logs of the Kafka Consumer app. Note that several events have been sent by the applications to the `kogito-processinstances-events` Kafka topic. The events contain information about the process instance, the nodes triggered and the state of the process variables: 
+
----
