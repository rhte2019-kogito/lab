...
----
. Using `oc` client, follow the logs of the builder pod. The build will take up to 10 minutes to complete. At the end of the build you shouldsee the following in the logs:
+
----
...
* The template defines an ImageStream for the Kogito S2I runktime image.
